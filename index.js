...
const debug = require('debug')('draftroom.index');
const socketUtil = require('./lib/socket/util');
server.listen(port, () => {
  debug(`Express server listening on port ${port}`);
});
const socketMgr = require('./lib/socket/manager');
const dispatcher = require('./lib/eventDispatcher');
const ChatTopic = require('./lib/topic/chat');
const DraftTopic = require('./lib/topic/draft');
const UserTopic = require('./lib/topic/user');
